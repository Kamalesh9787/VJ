...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/tmv_link")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002170998708').split()]
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002343414940').split()]
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://envs.sh/Ysg.jpg')
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+tuJZ4MeTcMtlNjE1')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '384a1b6a599b42aec68078df1a53c8143b01d74d')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/tmv_link')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/tmv_link') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
